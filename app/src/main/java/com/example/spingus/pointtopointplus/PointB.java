...
public class PointB extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public Double lat = -36.30850783320357;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( ContextCompat.checkSelfPermission( this, android.Manifest.permission.ACCESS_FINE_LOCATION ) != PackageManager.PERMISSION_GRANTED ) {
            Toast.makeText(PointB.this, "Please turn on your GPS with permissions",
        ...
        setContentView(R.layout.activity_point_b);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MapsActivity.location.updateB(lat,lon);
                Intent intent = new Intent(PointB.this, Nav.class);
